...
//    }
    ...
    @Override
    @PostMapping
    public ResponseEntity<RealisateurDTO> createRealisateur(@RequestBody @Valid RealisateurForm realisateurForm, @RequestParam String token) throws ControllerException {
        try {
    ...
    @Override
    @PutMapping("/{id}")
    public ResponseEntity<RealisateurDTO> updateRealisateur(@PathVariable long id, @RequestBody @Valid RealisateurForm realisateurForm, @RequestParam String token) throws ControllerException {
        try {
    ...
    @Override
    @DeleteMapping("/{id}")
    public ResponseEntity<?> deleteRealisateur(@PathVariable long id, @RequestParam String token) throws ControllerException {
        try {
