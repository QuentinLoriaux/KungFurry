...
//        when(jdbcTemplate.query(anyString(), any(RowMapper.class))).thenReturn(Arrays.asList(realisateur1, realisateur2));
...
//        when(jdbcTemplate.queryForObject(anyString(), any(RowMapper.class), eq(1L))).thenReturn(realisateur);
