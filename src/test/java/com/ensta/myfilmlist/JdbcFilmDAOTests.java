...
//
//        when(jdbcTemplate.query(anyString(), any(), any())).thenReturn(Arrays.asList(film));
...
//        Film film = new Film(1, "Inception", 148, realisateur, genre);
//
//        when(jdbcTemplate.queryForObject(anyString(), any(), anyLong())).thenReturn(film);
//        when(realisateurDAO.findById(1L)).thenReturn(Optional.of(realisateur));
//        when(genreDAO.getGenreById(1L)).thenReturn(Optional.of(genre));
//
//        // Execute
...
//        // Setup
//        when(jdbcTemplate.queryForObject(anyString(), any(), anyLong()))
...
//        Film film = new Film(1, "Inception", 148, realisateur, genre);
//
//        when(jdbcTemplate.query(anyString(), any(), anyInt(), anyInt())).thenReturn(Arrays.asList(film));
...
//        verify(jdbcTemplate, times(1)).query(anyString(), any(), anyInt(), anyInt());
